        ...
        if info.status == "creator" or ADMIN.id == IsDevloper():
            ...
            if not check_group(message.chat.id):
                ...
                if all_pre(bot, message.chat.id):
                    ...
                    bot.send_message(
                        chat_id=message.chat.id,
                        text   "! متبقاش بخيل لازم كل الصلاحيات! ",
                        parse_mode="HTML",
                    )
            else:
                bot.send_message(
            ...
            bot.send_message(
                chat_id=message.chat.id,
                text المطور او المالك عمك هات صغير لسه انت لعب بس ",
                parse_mode="HTML",
            )
        ...
        if info.status == "creator" or ADMIN.id == IsDevloper():
            ...
            if check_group(message.chat.id):
                ...
                if all_pre(bot, message.chat.id):
                    ...
                    bot.send_message(
                        chat_id=message.chat.id,
                        text="! الصلاحيات كل لازم بخيل متبقاش !",
                        parse_mode="HTML",
                    )
            else:
                bot.send_message(
            ...
            bot.send_message(
                chat_id=message.chat.id,
                text="المطور او للمالك دى الحجات هيا  لعب بس يقلبي",
                parse_mode="HTML",
            )
